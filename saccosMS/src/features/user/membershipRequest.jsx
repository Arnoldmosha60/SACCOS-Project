...
const MemberRequest = () => {
  const INITIAL_OBJ = {
    ...
    idara: '', check_namba: '', tarehe_ya_kuzaliwa: '', tarehe_ya_kuajiriwa: '', tarehe_ya_kustaafu: '', email: '',
    ...
    <div className="bg-blue-100 min-h-screen flex justify-center items-center">
      ...
      <div className="max-w-4xl max-h-2xl h-full w-full mx-auto bg-white elevation-5 rounded-lg overflow-hidden shadow-md px-8 py-8">
        <div className="flex items-center justify-between px-4 py-2 bg-white shadow-md">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Fomu ya Kuomba Uanachama wa DIT SACCOS</h1>
        ...
        {activeTab === 'sectionA' && (
          <form onSubmit={handleSubmit} method='POST'>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <InputText labelTitle="Check Namba " defaultValue={INITIAL_OBJ.check_namba} updateType='check_namba' updateFormValue={updateFormValue} placeholder="namba yako ya cheki" className="text-black" required />
          ...
          <>
            ...
            <div>
              <ul className='text-black p-4'>
                <li className='p-4'>
                  <b>KIINGILIO - </b> Kiasi cha Tshs 100,000/= kilipwe kwenye akaunti ya chama
                  Namba 01J109509980 yenye jina la DIT Savings and Credit Cooperative Society Ltd
                ...
                <li className='p-4'>
                  <b>HISA - </b> Kiasi cha makato kwa mwezi Tshs 100,000/= kwa muda wa miezi kumi (10) au kuweka Tshs 1,000,000/=
                  katika akaunti ya chama Namba 01J1095099800 yenye jina la DIT Savings and Credit Cooperative Society Ltd
                  iliopo CRDB Benki Vijana
                </li>
              </ul>
